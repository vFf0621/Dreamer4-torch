...
class Car:
        ...
        self.hull: Box2D.b2Body = self.world.CreateDynamicBody(
            ...
            fixtures=[
                fixtureDef(
                    ...
                    density=1.0,
                    categoryBits=0x0030|0x0020,
                    maskBits=0x0030|0x0020,
        ...
        for wx, wy in WHEELPOS:
            ...
            w = self.world.CreateDynamicBody(
                ...
                fixtures=fixtureDef(
                    ...
                    density=0.1,
                    categoryBits=0x0020|0x0030,
                    maskBits=0x001|0x0030,
                    restitution=0.0,
                ),
            )
    ...
    def steer(self, s):
        ...
        """
        self.wheels[0].steer = s+0.03
        self.wheels[1].steer = s-0.03
        self.wheels[2].steer = -0.03
        self.wheels[3].steer = 0.03
