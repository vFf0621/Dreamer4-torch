...
This default implementation uses RoPE1D(as stated in the paper) for time attention and learned PE for space attention, as well as the one directional masking for latent tokens in the encoder and decoder. Also, 
