...
class Dreamer4(nn.Module):
    # Default sizes: ~400M tokenizer (encoder+decoder at d=1024, depth 11)
    # + 1.27B dynamics (d=2048, depth 16), ~1.66B world model total.
    def __init__(self,agent_id, ch=3, h=96, w=96, patch = 16, latent_tokens=32, z_dim=16, action_dim=2, latent_dim=512,
                 rep_depth = 11, rep_d_model=1024, dyn_d_model=2048, dyn_depth=16, num_heads=16, dropout=0.1, k_max=8, mtp=8, action_low = -1, action_high = 1,
